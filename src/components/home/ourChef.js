...
const OurChef = () => {
    return (
        <div className='flex flex-row mt-24 w-full h-128'>
            ...
            <div className='flex flex-col w-full lg:w-1/2 h-10/12 justify-center pr-20'>
            ...
            {/* Chef image */}
            <div className='w-1/2 h-full bg-gradient-to-b from-white to-emerald-100 rounded-3xl hidden lg:flex'>
                <div className='flex w-full h-full'>
                    <img src={process.env.PUBLIC_URL + '/images/chef.png'} alt='chef' className='-ml-14 mt-1  absolute object-cover w-140' />
                </div>
            </div>
        </div>
    )
