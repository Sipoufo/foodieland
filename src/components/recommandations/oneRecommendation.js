...
const OneRecommendation = () => {
    ...
    return(
         ...
         * Important
         */
        <div className='flex flex-col rounded-2xl w-full p-4 h-96'>
            ...
            <div className='w-full h-4/6'>
                <img className='h-full w-full object-cover rounded-2xl' src={process.env.PUBLIC_URL + '/images/Foods/food9.png'} alt='category' />
            </div>
